...
export function PostCard({ post }: { post: Post }) {
	...
	return (
		<article onClick={handleNavigate} className="border-2 border-gray-400 rounded-xl shadow-sm hover:shadow-md transition cursor-pointer">
			<div className="flex flex-row gap-4 justify-between bg-gray-200 pt-4 px-4 relative">
				...
				{post.ensemble && <img src={EnsembleIcon} alt="ensemble icon" className="self-end opacity-20 absolute bottom-0 right-4" />}
			</div>
