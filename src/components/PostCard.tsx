...
export function PostCardEnsemble({ post }: { post: PostProps }) {
  return (
    <article className="border border-2 border-gray-400 rounded-xl">
      <div className="flex flex-row justify-between bg-gray-200 pt-4 px-4">
        ...
        <div className="grow">
          ...
          <p className="text-gray-800">
            <span className="font-body text-sm font-bold pr-2">
              {post.area}
            </span>{" "}
            •{" "}
            <span className="font-body text-sm pl-2">
              {post.numOfMusicians}
            </span>
          </p>
        </div>
      ...
      <h4 className="font-body text-xl font-bold text-blue-800 p-4">
        {post.description}
      </h4>

      <div className="flex flex-row justify-between px-4 pb-4">
        <h5 className="font-header text-xl text-blue-800 font-bold">
          {post.instrument}
        </h5>
