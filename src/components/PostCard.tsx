...
export function PostCardEnsemble() {
  return (
    <article className="border border-2 border-gray-400 rounded-xl">
      ...
      <h4
        id="description"
        className="font-body text-xl font-bold text-blue-800 p-4"
      >
      ...
      <div className="flex flex-row justify-between px-4 pb-4">
        <h5
          id="instrument"
          className="font-header text-xl text-blue font-bold  "
        >
          Violin
        </h5>
        <p
          id="experience"
          className="font-body text-md text-gray-800 font-bold  "
        >
          Erfaring
